namespace CshsClubGame.Models
{
    public class LootHelper
    {
        ...
        {
            new Equipment() { Quality = "普通", Name = "衛生紙", EnhancedAtk = 0, EnhancedHp = 1, Description = "皺巴巴的衛生紙掛在身上，別人就會對攻擊你有所遲疑" },
            new Equipment() { Quality = "普通", Name = "衛生紙", EnhancedAtk = 0, EnhancedHp = 1, Description = "皺巴巴的衛生紙掛在身上，別人就會對攻擊你有所遲疑"  },
            new Equipment() { Quality = "普通", Name = "衛生紙", EnhancedAtk = 0, EnhancedHp = 1, Description = "皺巴巴的衛生紙掛在身上，別人就會對攻擊你有所遲疑" },
            ...
            new Equipment() { Quality = "普通", Name = "紙飛機", EnhancedAtk = 2, EnhancedHp = 0, Description = "這種無人機在美國崛起之前就已經存在千年之久" },
            new Equipment() { Quality = "普通", Name = "洋芋片包裝", EnhancedAtk = 0, EnhancedHp = 3, Description = "此裝備的正式名稱為「氣態氮護具」，裡面的馬鈴薯片是不小心掉進去的" },
            new Equipment() { Quality = "普通", Name = "洋芋片包裝", EnhancedAtk = 0, EnhancedHp = 3, Description = "此裝備的正式名稱為「氣態氮護具」，裡面的馬鈴薯片是不小心掉進去的" },
            new Equipment() { Quality = "普通", Name = "巧克力棒", EnhancedAtk = 3, EnhancedHp = 0, Description = "不要懷疑，巧克力棒是一種武器，它會甜死人" },
            new Equipment() { Quality = "普通", Name = "巧克力棒", EnhancedAtk = 3, EnhancedHp = 0, Description = "不要懷疑，巧克力棒是一種武器，它會甜死人" },
            ...
            new Equipment() { Quality = "普通", Name = "菜刀", EnhancedAtk = 15, EnhancedHp = 0, Description = "家政教室找到的沉重鐵刀，聽說家政老師都用它來割韭菜" },
